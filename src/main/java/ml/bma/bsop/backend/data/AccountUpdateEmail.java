 ...
 * @author ironman
 */
public class AccountUpdateEmail implements Email{
    ...
    public AccountUpdateEmail(Locale locale,Token token) {
        this.locale = locale;
        ...
        switch (locale.getLanguage()) {
            case "cs":
                message = "<h2>Dobrý den,</h2><br/><br/>" +
                        "<p>právě jsi upravil účet v aplikaci BSOP Produkce.</p>" +
                        "<p>Pro dokončení této úpravy prosím klikni <a href='" + link + "'>sem</a>.</p><br/><br/>" +
                        "<p>S pozdravem</p><p>Aplikace <font color='blue'>BSOP Produkce</p>";
                break;
            case "en":
                message = "<h2>Hello,</h2><br/><br/>" +
                        "<p>you have just updated your BSOP Production account</p>" +
                        "<p>To complete the update, please click <a href='" + link + "'>here</a>.</p><br/><br/>" +
                        "<p>Regards</p><p><font color='blue'>BSOP Production</font> application<p>";
                break;
            case "de":
                message = "<h2>Hallo,</h2><br/><br/>" +
                        "<p>Sie haben gerade Ihren BSOP Production-Account bearbeitet.</p>" +
                        "<p>Um das Update abzuschließen, klicken Sie bitte hier <a href='" + link + "'>hier</a>.</p><br/><br/>" +
